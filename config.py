...
CUSTOM_PATH = f"{ROOMS_DIR}/tr{TRAINING_EPISODES}_x{WORKING_INTERVALS}_mSt{MAX_STEPS}_{AGGREATION_TYPE}_test{'Stochastic' if TEST_STOCHASTIC else 'Determenistic'}"
